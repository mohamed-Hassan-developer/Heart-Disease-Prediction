...
if page == 'Home':
    ...
    Age_pre = col1.slider('Age',step=1,value=40)
    ...
    Fasting_Blood_Sugar_pre = col7.number_input('Fasting Blood Sugar',min_value=40,value=80)

    BMI_pre = col8.number_input('BMI',min_value=15.000,max_value=35.000,value=20.000)
    ...
    Blood_Pressure_pre = col11.number_input('Blood Pressure',min_value=40,value=80 )

    Sleep_Hours_pre = col12.number_input('Sleep Hours',min_value=1.000,max_value=23.000,value=5.000)
